...
{
    public partial class GoodsEnterpriseDbContext : DbContext
    {
        public GoodsEnterpriseDbContext()
        {
        }

        public GoodsEnterpriseDbContext(DbContextOptions<GoodsEnterpriseDbContext> options)
            : base(options)
        {
        }
